    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      <div className="p-4">
        <div className="flex justify-between items-start mb-2">
          ...
          <span className={`px-3 py-1 rounded-full text-sm ${ticket.status === 'active' ? 'bg-emerald-400 text-white' : 'bg-gray-300 text-gray-700'}`}>
        ...
        {/* <div className="border-t pt-3">
          ...
          <p className="text-gray-500 text-sm">Your fur</p>
        </div> */}
